...
### 目标
用最小 DSL 表达算子设计意图，便于 LLM 理解和 kernel-generator 实现。
...
`@llm_hint` 给 LLM 提供优化提示，帮助 kernel-generator 选择最优实现策略。
...
**语义化描述，由 kernel-generator 根据硬件文档选择具体实现。**
...
# kernel-generator 会根据 Ascend NPU 硬件文档将其映射为：
